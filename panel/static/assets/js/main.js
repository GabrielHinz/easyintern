...
$('select option[value=""][selected]').text('--selecione--');


function showToast(message, type = 'primary') {
  var toastHTML = `
    <div class="mt-3 toast align-items-center text-bg-${type} border-0" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="d-flex">
